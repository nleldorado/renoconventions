(function (global, factory) {
  ...
  var Photo = function Photo(_ref) {
    ...
    return React__default.createElement("img", _extends({
      key: key,
      style: onClick ? _objectSpread2({}, imgStyle, {}, imgWithClick) : imgStyle
    }, photo, {
  ...
  var useIsomorphicLayoutEffect = _isBrowser ? React.useLayoutEffect : React.useEffect;
  var Gallery = React__default.memo(function Gallery(_ref) {
    ...
    var _useState = React.useState(1200),
    ...
    useIsomorphicLayoutEffect(function () {
      ...
      var observer = new ResizeObserver(function (entries) {
        ...
        if (containerWidth !== newWidth && _isBrowser) {
    ...
    columns = 3; //if (containerWidth >= 800) columns = 3;

    var screenWidth = _isBrowser ? window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth : 1200;
    var margin = screenWidth < 769 ? 3 : 4;
    galleryStyle = {
      position: 'relative'
    };
